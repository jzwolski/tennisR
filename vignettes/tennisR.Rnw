...
s first serve percentage from June 1, 2015 to his last match at the 2015 U.S. Open.  Murray's first serve percentage ranges between 54\% and 79\% during this time frame.'

<<murray, echo=FALSE, fig.height=3.5, fig.width=5, fig.align='center',fig.cap='Andy Murray'>>=
